...
./node_modules/.bin/snarkjs r1cs export json magicNumber.r1cs magicNumber.r1cs.json
./node_modules/.bin/snarkjs plonk setup magicNumber.r1cs pot12_final.ptau magicNumber_final.zkey
./node_modules/.bin/snarkjs zkey export verificationkey magicNumber_final.zkey verification_key.json
rm pot12_final.ptau 
rm pot12_beacon.ptau
rm response_0003
rm magicNumber.r1cs
rm magicNumber.r1cs.json
rm challenge_0003
rm magicNumber.sym