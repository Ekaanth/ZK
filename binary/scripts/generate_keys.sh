...
./node_modules/.bin/snarkjs r1cs export json binaryCheck.r1cs binaryCheck.r1cs.json
./node_modules/.bin/snarkjs plonk setup binaryCheck.r1cs pot12_final.ptau binaryCheck_final.zkey
./node_modules/.bin/snarkjs zkey export verificationkey binaryCheck_final.zkey verification_key.json
rm pot12_final.ptau 
rm pot12_beacon.ptau
rm response_0003
rm binaryCheck.r1cs
rm binaryCheck.r1cs.json
rm challenge_0003
rm binaryCheck.sym