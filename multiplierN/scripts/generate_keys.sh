...
./node_modules/.bin/snarkjs r1cs export json multiplierN.r1cs multiplierN.r1cs.json
./node_modules/.bin/snarkjs plonk setup multiplierN.r1cs pot12_final.ptau multiplierN_final.zkey
./node_modules/.bin/snarkjs zkey export verificationkey multiplierN_final.zkey verification_key.json
rm pot12_final.ptau 
rm pot12_beacon.ptau
rm response_0003
rm multiplierN.r1cs
rm multiplierN.r1cs.json
rm challenge_0003
rm multiplierN.sym